...
public class DevImpl {
    ...
    void initDatabase() throws Exception {
			...
			Motor motor1 = new Motor("1.0 TSI", 3, 12, 116, 200, "Turbo");
			Motor motor2 = new Motor("1.0 Firefly", 3, 6, 77, 106, "Natural");
			Motor motor3 = new Motor("1.6 16V", 4, 16, 118, 158, "Natural");
			Motor motor4 = new Motor("2.0 Turbo", 4, 16, 280, 400, "Turbo");
			Motor motor5 = new Motor("3.0 V6 Bi-Turbo", 6, 24, 385, 520, "BiTurbo");
			Motor motor6 = new Motor("4.0 V8 Twin-Turbo", 8, 32, 720, 770, "BiTurbo");
			Motor motor7 = new Motor("6.5 V12", 12, 48, 770, 720, "Natural");
			Motor motor8 = new Motor("8.0 W16 Quad-Turbo", 16, 64, 1500, 1600, "QuadTurbo");
			Motor motor9 = new Motor("2.5 TFSI", 5, 20, 400, 480, "Turbo");
			Motor motor10 = new Motor("1.4 TSI", 4, 16, 150, 250, "Turbo");
			Motor motor11 = new Motor("1.5 Turbo", 4, 16, 173, 220, "Turbo");
			Motor motor12 = new Motor("2.0 Ecoboost", 4, 16, 250, 366, "Turbo");
			Motor motor13 = new Motor("2.0 TSI", 4, 16, 220, 350, "Turbo");
			Motor motor14 = new Motor("2.9 V6", 6, 24, 440, 550, "BiTurbo");
			Motor motor15 = new Motor("5.2 V10", 10, 40, 640, 600, "Natural");
			Motor motor16 = new Motor("1.3 Turbo", 4, 16, 185, 270, "Turbo");
			Motor motor17 = new Motor("1.6 THP", 4, 16, 165, 240, "Turbo");
			Motor motor18 = new Motor("1.2 PureTech", 3, 12, 130, 230, "Turbo");
			Motor motor19 = new Motor("1.0 Turbo", 3, 12, 125, 200, "Turbo");
			Motor motor20 = new Motor("3.8 Flat-6 Biturbo", 6, 24, 650, 800, "BiTurbo");
			Motor motor21 = new Motor("3.9 V8 BiTurbo", 8, 32, 720, 770, "BiTurbo"); // Ferrari
			Motor motor22 = new Motor("6.2 V8", 8, 16, 455, 624, "Natural"); // Chevrolet
			...
			Carro gol = new Carro("Gol", "2022", "Hatch compacto popular com motor turbo eficiente.", "Gasolina", "Manual",
					...
					"https://upload.wikimedia.org/wikipedia/commons/1/1e/Volkswagen_Gol_2022.jpg", volkswagen, motor1 // 1.0
																														// TSI
			);
			...
			Carro tiguan = new Carro("Tiguan", "2023", "SUV médio com tecnologia e conforto.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/2/2b/Volkswagen_Tiguan_2023.jpg", volkswagen, motor4 // 2.0
																															// Turbo
			);
			...
			Carro argo = new Carro("Argo", "2023", "Hatch moderno com motor Firefly flex.", "Gasolina/Álcool", "Manual",
					...
					"https://upload.wikimedia.org/wikipedia/commons/3/3c/Fiat_Argo_2023.jpg", fiat, motor2 // 1.0 Firefly
			);
			...
			Carro toro = new Carro("Toro", "2023", "Picape média com motor turbo.", "Diesel", "Automático", "Dianteira", 6,
					...
					"https://upload.wikimedia.org/wikipedia/commons/4/4d/Fiat_Toro_2023.jpg", fiat, motor11 // 1.5 Turbo
			);
			...
			Carro ka = new Carro("Ka", "2022", "Hatch econômico com motor 1.0 Turbo.", "Gasolina", "Manual", "Dianteira", 5,
					...
					"https://upload.wikimedia.org/wikipedia/commons/5/5e/Ford_Ka_2022.jpg", ford, motor19 // 1.0 Turbo
			);
			...
			Carro mustang = new Carro("Mustang GT", "2023", "Ícone esportivo com motor V8.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/6/6f/Ford_Mustang_GT_2023.jpg", ford, motor6 // 4.0 V8
																													// Twin-Turbo
			);
			...
			Carro onix = new Carro("Onix", "2023", "Hatch compacto com motor turbo flex.", "Gasolina/Álcool", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/7/7a/Chevrolet_Onix_2023.jpg", chevrolet, motor16 // 1.3
																														// Turbo
			);
			...
			Carro camaro = new Carro("Camaro SS", "2023", "Muscle car com motor V8 aspirado.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/8/8b/Chevrolet_Camaro_SS_2023.jpg", chevrolet, motor7 // 6.5
			);
			...
			Carro a3 = new Carro("A3", "2023", "Sedan premium com motor TFSI.", "Gasolina", "Automático", "Dianteira", 7,
					...
					"https://upload.wikimedia.org/wikipedia/commons/9/9c/Audi_A3_2023.jpg", audi, motor9 // 2.5 TFSI
			);
			...
			Carro r8 = new Carro("R8", "2023", "Supercarro com motor V10 natural.", "Gasolina", "Automático", "Traseira", 7,
					...
					"https://upload.wikimedia.org/wikipedia/commons/a/a1/Audi_R8_2023.jpg", audi, motor15 // 5.2 V10
			);
			...
			Carro serie3 = new Carro("Série 3", "2023", "Sedan esportivo com motor turbo.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/b/b2/BMW_Serie_3_2023.jpg", bmw, motor5 // 3.0 V6
																											// Bi-Turbo
			);
			...
			Carro m5 = new Carro("M5", "2023", "Sedan de alta performance com V8 biturbo.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/c/c3/BMW_M5_2023.jpg", bmw, motor6 // 4.0 V8 Twin-Turbo
			);
			...
			Carro f8Tributo = new Carro("F8 Tributo", "2023", "Supercarro com motor V8 biturbo.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/d/d4/Ferrari_F8_Tributo_2023.jpg", ferrari, motor14 // 3.9
																														// V8
																														// biturbo
			);
			...
			Carro huracan = new Carro("Huracán", "2023", "Supercarro com motor V10 natural.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/e/e5/Lamborghini_Huracan_2023.jpg", lamborghini, motor15 // 5.2
																																// V10
			);
			...
			Carro chiron = new Carro("Chiron", "2023", "Hipercarro com motor W16 quad-turbo.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/f/f6/Bugatti_Chiron_2023.jpg", bugatti, motor8 // 8.0
																													// W16
																													// Quad-Turbo
			);
			...
			Carro cayenne = new Carro("Cayenne", "2023", "SUV de luxo com motor V6 biturbo.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/g/g7/Porsche_Cayenne_2023.jpg", porsche, motor5 // 3.0
																													// V6
																													// Bi-Turbo
			);
			...
			Carro gt3rs = new Carro("911 GT3 RS", "2023", "Esportivo de pista com motor flat-6.", "Gasolina", "Automático",
					...
					"https://upload.wikimedia.org/wikipedia/commons/h/h8/Porsche_911_GT3_RS_2023.jpg", porsche, motor20 // 3.8
																														// Flat-6
																														// BiTurbo
			);
